...
public class solver161 {
    ...
    private static class ContraptionGridBuilder {
        ...
        public static class ContraptionGrid {
            ...
            public LightGrid fillLightGrid(Coord2D startCoord, Direction startDirection) {
                ...
                Contraption firstContraption = startDirection.getConnect(startCoord, condensedRows, condensedColumns)
                        .getValue();
                if (condensedRows.get(0).containsKey(0)) {
    ...
    public static void main(String[] args) {
        ...
        try (Stream<String> inputLines = Files.lines(new File("inputs/input_16").toPath())) {
            ...
            energizedCount = lightGrid.litSquareCount();
            System.out.print(lightGrid);
